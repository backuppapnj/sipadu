...
import type { CategoryFormData, BreadcrumbItem } from '@/types';
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="code" value={form.data.code} onChange={(e) => form.setData('code', e.target.value.toUpperCase())} maxLength={10} placeholder="Contoh: ADM" aria-invalid={!!form.errors.code} />
